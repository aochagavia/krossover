...
if "%WIN_ARCH%" equ "AMD64" (
    set JVM_TARGET_DIR=%BUILD_DIR%\OpenJDK21U-jdk_x64_windows_hotspot_21.0.8_9-165771\
    set JVM_URL=https://github.com/adoptium/temurin21-binaries/releases/download/jdk-21.0.8%%2B9/OpenJDK21U-jdk_x64_windows_hotspot_21.0.8_9.zip
