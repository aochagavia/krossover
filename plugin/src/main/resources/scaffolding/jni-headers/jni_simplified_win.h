...
struct JNINativeInterface_ {
    ...
    jobject (__stdcall *NewObjectV)
      (JNIEnv *env, jclass clazz, jmethodID methodID, int args);
    ...
    jobject (__stdcall *CallObjectMethodV)
      (JNIEnv *env, jobject obj, jmethodID methodID, int args);
    ...
    void (__stdcall *CallStaticVoidMethodV)
      (JNIEnv *env, jclass cls, jmethodID methodID, int args);
    ...
    jint (__stdcall *RegisterNatives)
      (JNIEnv *env, jclass clazz, int methods,
       jint nMethods);
    ...
    jobject (__stdcall *GetModule)
       (JNIEnv* env, jclass clazz);

    /* Virtual threads */

    jboolean (__stdcall *IsVirtualThread)
       (JNIEnv* env, jobject obj);
};
